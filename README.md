...
| Spending_Score     | Normalized spending behavior (1–100)          |
| Visit_Frequency    | Number of mall visits (engagement score)      |
| Avg_Time_Spent_Min | Time spent inside the mall per visit          |
| Payment_Method     | UPI / Card / Wallet                           |
| Loyalty_Member     | Indicates loyalty program membership (Yes/No) |
...
4. Load the Dataset:
Ensure dataset (Mall_Customers.xlsx) is in the project folder.
